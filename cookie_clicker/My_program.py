# BuildInfo class - http://www.codeskulptor.org/#user39_HEA8jCtnVZ_0.py
# http://www.codeskulptor.org/#user39_iH45aV39e6_24.py
# http://www.codeskulptor.org/#user39_8kLkZ5EUxo_3.py
# http://www.codeskulptor.org/#user39_8kLkZ5EUxo_10.py
...
def strategy_best(cookies, cps, history, time_left, build_info):
    ...
    """
#    best_item = ""
#    best_cookie_production = float('-inf')
#    clone_build_info = build_info.clone()
#    item_list = build_info.build_items()
#    for item in item_list:
#        local_time = 0.0 
#        c_cookies = cookies
#        increment_time = clone_build_info.        
